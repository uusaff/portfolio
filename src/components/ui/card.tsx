...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        'glass-card rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_1px_2px_hsl(var(--color-foreground)/0.04),0_8px_24px_hsl(var(--color-foreground)/0.08)] hover:border-border/80',
        className
      )}
      {...props}
    />
